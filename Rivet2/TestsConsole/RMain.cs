...
//*************************************
namespace Alfray.Rivet.TestsConsole
{
	//***************************************************
	/// <summary>
	...
	public class RMain
	{
		...
		{
			typeof(Alfray.LibUtils2.Tests.LibVersion)
		};
		...
		{
			Console.WriteLine("Rivet2 TestsConsole Main");
			System.Diagnostics.Trace.WriteLine("Rivet2 TestsConsole Main");
